"""Static device inventory for the SONiC lab.

Devices can be referenced by management IP or by short name ('vm1', 'vm2').
Unknown references resolve to an ad-hoc SonicDevice so callers aren't blocked
on inventory registration.
"""
